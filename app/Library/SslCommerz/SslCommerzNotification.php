...
//                    }
    ...
    public function setCustomerInfo(array $info)
    {
        ...
        $this->data['cus_add2'] = (isset($info['cus_add2'])) ? $info['cus_fax'] : ''; // string (50)	Address line 2 of your customer. Not mandatory but useful if provided
    ...
    public function setProductInfo(array $info)
    {
        ...
        $this->data['product_codes'] = (isset($info['product_codes'])) ? $info['product_codes'] : ''; // String (100)	Mandatory - Mention the product category. Example: Electronic or topup or bus ticket or air ticket
