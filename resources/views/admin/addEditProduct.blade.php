...
@section('content')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ url('admin/add-edit-product') }}">Add
                                    Products</a></li>
                        </ol>
                    </div>
                </div>
        ...
        <section class="content">
            ...
            <!-- Add Product form -->
                <form method="post" @if(empty($productData['id'])) action="{{ url('admin/add-edit-product') }}"
                      @else action="{{ url('admin/add-edit-product/'.$productData['id']) }}" @endif id="addProductForm"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Product Color"
                                               name="product_color" id="productColor"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div>
                                        @if(!empty($productData['product_image']))
                                            <img
                                                src="{{ asset('images/productImages/small/'.$productData['product_image']) }}"
                                                alt="image!"
                                                style="margin-top: 5px; height: 80px; width: 80px; margin-bottom: 5px">
                                            &nbsp; <a class="btn btn-danger deleteBtn confirmDelete"
                                                      href="javascript:void(0)" record="product-image"
                                                      recordId="{{ $productData['id'] }}" title="Delete Image"><i
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Product Weight"
                                               name="product_weight" id="productWeight"
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Product Price"
                                               name="product_price" id="productPrice"
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Product Discount"
                                               name="product_discount" id="productDiscount"
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    @if(!empty($productData['product_video']))
                                        <a href="{{ url('videos/productVideos/'.$productData['product_video']) }}"
                                           download>Download Video</a>
                                        ||
                                        <a class="btn btn-danger deleteBtn confirmDelete" href="javascript:void(0)"
                                           record="product-video" recordId="{{ $productData['id'] }}"
                                           title="Delete Video"><i class="fas fa-trash"></i></a>
                                @endif
                                <!-- /.form-group -->
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" placeholder="Enter Wash Care ..."
                                                  name="wash_care"
                                                  id="wash_care">@if(!empty($productData['wash_care'])) {{$productData['wash_care']}} @else {{old('wash_care')}} @endif</textarea>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3"
                                                  ...
                                                  id="productDes">@if(!empty($productData['product_description'])) {{$productData['product_description']}} @else {{old('product_description')}} @endif</textarea>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" placeholder="Enter Meta Description ..."
                                                  name="meta_description"
                                                  id="metaDes">@if(!empty($productData['meta_description'])) {{ $productData['meta_description'] }} @else {{ old('meta_description') }} @endif</textarea>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="fabric" class="form-control select2" style="width: 100%;"
                                                id="category_id">
                                            <option value="" selected>Select</option>
                                            @foreach($fabricArray as $fabric)
                                                <option value="{{ $fabric['filter_value'] }}"
                                                        @if(!empty($productData['fabric']) && $productData['fabric'] == $fabric['filter_value']) selected @endif>{{ $fabric['filter_value'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!-- /.form-group -->
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="sleeve" class="form-control select2" style="width: 100%;"
                                                id="sleeve">
                                            <option value="" selected>Select</option>
                                            @foreach($sleeveArray as $sleeve)
                                                <option value="{{ $sleeve['filter_value'] }}"
                                                        @if(!empty($productData['sleeve']) && $productData['sleeve'] == $sleeve['filter_value']) selected @endif>{{ $sleeve['filter_value'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!-- /.form-group -->
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="pattern" class="form-control select2" style="width: 100%;"
                                                id="pattern">
                                            <option value="" selected>Select</option>
                                            @foreach($patternArray as $pattern)
                                                <option value="{{ $pattern['filter_value'] }}"
                                                        @if(!empty($productData['pattern']) && $productData['pattern'] == $pattern['filter_value']) selected @endif>{{ $pattern['filter_value'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!-- /.form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="fit" class="form-control select2" style="width: 100%;" id="fit">
                                            ...
                                            @foreach($fitArray as $fit)
                                                <option value="{{ $fit['filter_value'] }}"
                                                        @if(!empty($productData['fit']) && $productData['fit'] == $fit['filter_value']) selected @endif>{{ $fit['filter_value'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!-- /.form-group -->
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="occasion" class="form-control select2" style="width: 100%;"
                                                id="occasion">
                                            <option value="" selected>Select</option>
                                            @foreach($occasionArray as $occasion)
                                                <option value="{{ $occasion['filter_value'] }}"
                                                        @if(!empty($productData['occasion']) && $productData['occasion'] == $occasion['filter_value']) selected @endif>{{ $occasion['filter_value'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!-- /.form-group -->
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Meta Keyword"
                                               name="meta_keywords" id="productUrl"
